...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.member-church-contacts.update', [$memberChurchContact->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('member_church_name') ? 'is-invalid' : '' }}" type="text"
                        name="member_church_name" id="member_church_name"
                        value="{{ old('member_church_name', $memberChurchContact->member_church_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text"
                        name="email" id="email" value="{{ old('email', $memberChurchContact->email) }}">
                    @if ($errors->has('email'))
                        <div class="invalid-feedback">
                            {{ $errors->first('email') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text"
                        ...
                        value="{{ old('phone_number', $memberChurchContact->phone_number) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address"
                        id="address">{!! old('address', $memberChurchContact->address) !!}</textarea>
