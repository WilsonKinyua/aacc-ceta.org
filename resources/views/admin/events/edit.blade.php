    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="when">{{ trans('cruds.event.fields.when') }}</label>
                <input class="form-control {{ $errors->has('when') ? 'is-invalid' : '' }}" type="text" name="when" id="when" value="{{ old('when', $event->when) }}" required>
                @if($errors->has('when'))
                    <div class="invalid-feedback">
                        {{ $errors->first('when') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.when_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="poster">{{ trans('cruds.event.fields.poster') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.poster_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($event) && $event->poster)
      var file = {!! json_encode($event->poster) !!}
