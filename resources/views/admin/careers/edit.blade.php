    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.careers.update", [$career->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="career_document_preview">{{ trans('cruds.career.fields.career_document_preview') }}</label>
                <div class="needsclick dropzone {{ $errors->has('career_document_preview') ? 'is-invalid' : '' }}" id="career_document_preview-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('career_document') ? 'is-invalid' : '' }}" id="career_document-dropzone">
                </div>
...
@if(isset($career) && $career->career_document_preview)
      ...
      $('form').append('<input type="hidden" name="career_document_preview" value="' + file.file_name + '">')
      this.options.maxFiles = this.options.maxFiles - 1
@endif
    },
